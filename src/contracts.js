export const SCRYV_REGISTRY_ABI = [
...
// Set VITE_SCRYV_REGISTRY after deployment. Keeping the address in env makes
// the same frontend build portable between testnet and mainnet.
export const SCRYV_REGISTRY_ADDRESS = import.meta.env.VITE_SCRYV_REGISTRY || '0x0000000000000000000000000000000000000000'
